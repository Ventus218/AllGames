                        ...
                        <header>
                            <div class="row">
                                <div class="col clearfix">
                                    <img class="rounded-circle float-start me-2" src=" <?php echo (isset($utente->urlImmagine) ? $utente->urlImmagine : "../inc/img/profile-pic.png"); ?> " alt="Immagine profilo di <?php echo $utente->username; ?>" />
