                        ...
                        <header>
                            <div class="row">
                                <div class="col clearfix">
                                    <img class="profile-pic float-start me-2" src=" <?php echo (isset($utente->urlImmagine) ? $utente->urlImmagine : "../inc/img/profile-pic.png"); ?> " alt="Immagine profilo di <?php echo $utente->username; ?>" />
