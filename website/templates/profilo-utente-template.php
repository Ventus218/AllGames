                        ...
                        <header>
                            <div class="row align-items-center">
                                <div class="col-auto pe-0">
                                    <img class="profile-pic rounded-circle" src=" <?php echo (isset($utente->urlImmagine) ? getMultimediaURL($utente->urlImmagine) : "inc/img/profile-pic.png"); ?> " alt="Immagine di profilo dell'utente <?php echo $utente->username; ?>" />
                                </div>
                                <div class="col">
                                            ...
                                            ?>
                                                ...
                                                <div class="row text-start <?php if($i < $followsNumber-1) echo "mb-3"; ?>">
                                                    <a href="profilo-utente.php?utente=<?php echo escapeSpacesForURIParam($follow->id) ?>" class="text-decoration-none text-white">
                                                        <img class="ricerca-pic rounded-circle" src="<?php echo (isset($follow->urlImmagine) ? getMultimediaURL($follow->urlImmagine) : "inc/img/profile-pic.png"); ?> " alt="Immagine profilo di <?php echo $follow->username; ?>" />
                                            ...
                                            ?>
                                                ...
                                                <div class="row text-start <?php if($i < $followersNumber-1) echo "mb-3"; ?>">
                                                    <a href="profilo-utente.php?utente=<?php echo escapeSpacesForURIParam($follower->id) ?>" class="text-decoration-none text-white">
                                                        <img class="ricerca-pic rounded-circle" src="<?php echo (isset($follower->urlImmagine) ? getMultimediaURL($follower->urlImmagine) : "inc/img/profile-pic.png"); ?> " alt="Immagine profilo di <?php echo $follower->username; ?>" />
                    ...
                    <div class="row d-flex justify-content-evenly gap-1 overflow-auto communities-height">
                        ...
                        <div class="row">
                            <a href="<?php echo "community.php?community=".escapeSpacesForURIParam($community->nome); ?>" class="col-auto text-warning text-decoration-none d-flex flex-row align-items-center">
                                <img src="<?php echo (isset($community->urlImmagine) ? getMultimediaURL($community->urlImmagine) : "inc/img/people.png"); ?>" alt="Immagine della community <?php echo $community->nome; ?>" class="post-profile-pic rounded-circle me-2" />
