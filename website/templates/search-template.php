<div class="row">
    ...
    <div class="row me-1">
        <div class="col-11 pe-0">
            <label for="search" class="visually-hidden">Cerca degli utenti, delle community o dei tag</label>
            <input class="form-control mb-3" type="text" name="search" id="search" placeholder="Cerca degli utenti, delle community o dei tag" required />
        </div>
        <div class="col-1 ps-0">
            <button type="submit" class="btn p-0">
                <img class="search-img opacity-50" alt="Tasto per cercare" src="inc/img/search.png" />
            </button>
        </div>
    </div>
    </form>
